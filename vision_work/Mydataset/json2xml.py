...
# 1.标签路径
labelme_path = r"D:\ultralytics-8.1.0\vision_work\Mydataset\original_dataset"  # 原始json、bmp标注数据路径,需要更换成自己的数据集名称
saved_path = r"D:\ultralytics-8.1.0\vision_work\Mydataset\data\Annotations"  # 保存路径
